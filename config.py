...
# === Chaves e Ativo ===
# FRED_API_KEY removida — não usada com Ollama local
...
OLLAMA_API_BASE_URL = "http://109.199.107.136:11434/api/chat"
OLLAMA_MODEL_NAME =  "qwen2.5:1.5b"  #"deepseek-r1:1.5b"

# Remove DEEPSEEK_* antigos (não usados)
